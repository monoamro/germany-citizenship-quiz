export const questions = [
  ...
  },
  {
    ...
    answerOptions: [
      ...
      {
        answerText: 'B) den Bundespräsidenten / die Bundespräsidentin',
        isCorrect: true,
      },
  ...
  },
  {
    ...
    answerOptions: [
      {
        answerText: 'A) Er / Sie kontrolliert die Regierungspartei.',
        isCorrect: false,
      },
      {
        answerText: 'B) Er / Sie führt die Regierungsgeschäfte.',
        isCorrect: false,
      },
      {
        answerText: 'C) Er / Sie wählt die Minister / Ministerinnen aus.',
        isCorrect: false,
      },
      {
        answerText: 'D) Er / Sie schlägt den Kanzler / die Kanzlerin zur Wahl vor.',
        isCorrect: true,
      },
    ],
  },
  ...
  },
  {
    ...
    answerOptions: [
      {
        answerText: 'A) nur Personen mit einem abgeschlossenen Jurastudium',
        isCorrect: false,
      },
      {
        answerText: 'B) alle deutschen Staatsangehörigen älter als 24 und jünger als 70 Jahre',
        isCorrect: true,
      },
      {
        answerText: 'C) alle in Deutschland geborenen Einwohner / Einwohnerinnen über 18 Jahre',
        isCorrect: false,
      },
      {
        answerText: 'D) alle Personen, die seit mindestens 5 Jahren in Deutschland leben',
        isCorrect: false,
      },
    ],
  },
  ...
  },
  {
    ...
    answerOptions: [
      {
        answerText: 'A) landesweite Streiks und ein Volksaufstand',
        isCorrect: true,
      },
      { answerText: 'B) der 1. SED-Parteitag', isCorrect: false },
      {
        answerText: 'C) der feierliche Beitritt zum Warschauer Pakt',
        isCorrect: false,
      },
  ...
  },
  {
    ...
    answerOptions: [
      {
        answerText: 'A) der Bundespräsident / die Bundespräsidentin',
        isCorrect: false,
      },
      {
        answerText: 'B) der Bundeskanzler / die Bundeskanzlerin',
        isCorrect: true,
      },
      {
        answerText: 'C) der Bundesratspräsident / die Bundesratspräsidentin',
        isCorrect: false,
      },
      {
        answerText: 'D) der Bundestagspräsident / die Bundestagspräsidentin',
        isCorrect: false,
      },
    ],
  },
  {
    ...
    answerOptions: [
      ...
      {
        answerText: 'B) die Länder, die in die EU eintreten dürfen',
        isCorrect: false,
      },
      {
        answerText: 'C) die Abgeordneten des Europäischen Parlaments',
        isCorrect: true,
      },
  ...
  },
  {
    ...
    answerOptions: [
      {
        answerText: 'A) durch eine Revolution in Deutschland',
        isCorrect: false,
      },
      {
        answerText: 'B) durch die bedingungslose Kapitulation Deutschlands',
        isCorrect: true,
      },
      {
        answerText: 'C) mit dem Rückzug der Deutschen aus den besetzten Gebieten',
        isCorrect: false,
      },
  ...
  },
  {
    ...
    answerOptions: [
      ...
      {
        answerText: 'B) der Bundespräsident / die Bundespräsidentin',
        isCorrect: false,
      },
  ...
  },
  {
    ...
    answerOptions: [
      {
        answerText: 'A) überwacht die Einhaltung der Gesetze.',
        isCorrect: false,
      },
  ...
  },
  {
    ...
    answerOptions: [
      ...
      {
        answerText: 'B) Ehrentitel „Held der Deutschen Demokratischen Republik“.',
        isCorrect: false,
      },
  ...
  },
  {
    ...
    answerOptions: [
      {
        answerText: 'A) bilden Staat und Religionsgemeinschaften eine Einheit.',
        isCorrect: false,
      },
      {
        answerText: 'B) ist der Staat abhängig von den Religionsgemeinschaften.',
        isCorrect: false,
      },
      {
        answerText: 'C) bilden die Religionsgemeinschaften den Staat.',
        isCorrect: false,
      },
      {
        answerText: 'D) sind Staat und Religionsgemeinschaften voneinander getrennt.',
        isCorrect: true,
      },
    ],
  },
  ...
  },
  {
    ...
    answerOptions: [
      {
        answerText: 'A) Ministerpräsidenten / Ministerpräsidentinnen.',
        isCorrect: false,
      },
  ...
  },
  {
    ...
    answerOptions: [
      {
        answerText: 'A) das Recht zur freien Entfaltung der Persönlichkeit',
        isCorrect: false,
      },
  ...
  },
  {
    ...
    answerOptions: [
      {
        answerText: 'A) Der König / die Königin herrscht über das Volk.',
        isCorrect: false,
      },
      {
        answerText: 'B) Die Staatsgewalt geht vom Volke aus.',
        isCorrect: true,
      },
      {
        answerText: 'C) Das Bundesverfassungsgericht steht über der Verfassung.',
        isCorrect: false,
      },
      {
        answerText:
          'D) Die Interessenverbände üben die Souveränität zusammen mit der Regierung aus.',
        isCorrect: false,
      },
    ],
  },
  ...
  },
  {
    ...
    answerOptions: [
      {
        answerText: 'A) Oberbürgermeister / Oberbürgermeisterin',
        isCorrect: false,
      },
      {
        answerText: 'B) Ministerpräsident / Ministerpräsidentin',
        isCorrect: false,
      },
      {
        answerText: 'C) Regierender Bürgermeister / Regierende Bürgermeisterin',
        isCorrect: false,
      },
